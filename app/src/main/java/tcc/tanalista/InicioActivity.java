...
public class InicioActivity extends AppCompatActivity
    ...
    ImageButton promocao;
    ImageButton listacompra;
    ImageButton mercado;
    ImageButton produto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Iniciar","onCreate_InicioActivity");

        promocao = (ImageButton)findViewById(R.id.btnPromocao);
        listacompra = (ImageButton)findViewById(R.id.btnListaCompra);
        mercado = (ImageButton)findViewById(R.id.btnMercado);
        produto = (ImageButton)findViewById(R.id.btnProduto);
        ...
        mercado.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getApplicationContext(),MercadoActivity.class));
